...
const base = new Airtable({ apiKey: "keytReU5ICIRZNgpg" }).base("appx5oKfahgMZgKfy");
      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-extrabold text-gray-900">Featured Features</h2>
        ...
        <div className="relative max-w-lg mx-auto divide-y-2 divide-gray-200 lg:max-w-7xl">
          <div>
            <h2 className="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl">
              Recent tweets related to popupsmart
            </h2>
...
export async function getStaticProps() {
  ...
  const posts = result.map((entry) => {
    return {
      ...
      category: { name: "News", href: "#", color: "bg-indigo-100 text-indigo-800" },
